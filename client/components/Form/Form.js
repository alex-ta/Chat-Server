...
class Form extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    this.setState({fields: nextProps.fields, buttonText: nextProps.buttonText, successRedirect: nextProps.successRedirect, successFunction: nextProps.successFunction, signFunction: nextProps.signFunction})
    this.init(nextProps);
  }
  ...
  handelSubmit(e) {
    ...
    if (isValid) {
      ...
      this.state.signFunction({data: formdata, target: this.state.buttonText}).then((suc) => {
        this.state.successFunction();
