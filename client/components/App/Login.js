	...
	<div className="card card-container">
		...
		<form className="form-signin">
					<div className={classnames('form-group', { 'has-error': this.state.errors["username"] })}>
					  ...
					  <input type="text" id="username" name="username" className="form-control" placeholder="Username" required="" autoFocus="" onChange={this.onChange} />
					...
					<div className={classnames('form-group', { 'has-error': this.state.errors["password"] })}>
					  ...
					  <input type="password" id="password" name="password" className="form-control" placeholder="Password" required="" autoFocus="" onChange={this.onChange} />
